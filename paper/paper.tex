...
\begin{table}[ht]
\centering
\caption{Phrase-disjoint test results (\%, $n=2{,}296$, 38 template clusters). $R_{call}^{exact}$: exact call recall; ``--'' indicates undefined $F_1$ due to zero predicted abstentions.}
\label{tab:phrase}
\scriptsize
\resizebox{\columnwidth}{!}{%
\begin{tabular}{lrrrrrr}
\toprule
\textbf{System} & \textbf{Parse} & \textbf{Valid} & \textbf{Exact} & \textbf{$R_{call}^{exact}$} & \textbf{Abstain F1} & \textbf{Template exact} \\
\midrule
Always abstain & 100.00 & 100.00 & 50.00 & 0.00 & 66.67 & 76.32 \\
Lexical control & 100.00 & 100.00 & \textbf{77.40} & \textbf{54.79} & 81.56 & \textbf{89.47} \\
...
\begin{table}[ht]
\centering
\caption{Official speaker-disjoint test results (\%, $n=1{,}934$).}
\label{tab:official}
\scriptsize
\resizebox{\columnwidth}{!}{%
\begin{tabular}{lrrrrr}
\toprule
\textbf{System} & \textbf{Parse} & \textbf{Valid} & \textbf{Exact} & \textbf{$R_{call}^{exact}$} & \textbf{Template exact} \\
\midrule
Always abstain & 100.00 & 100.00 & 50.00 & 0.00 & 75.71 \\
Lexical control & 100.00 & 100.00 & \textbf{77.92} & \textbf{55.84} & \textbf{89.07} \\
